...
dofile(modular_computers.mod.path .. "/src/os/bin/files.lua")
dofile(modular_computers.mod.path .. "/src/os/bin/system.lua")
dofile(modular_computers.mod.path .. "/src/os/bin/edit.lua")
